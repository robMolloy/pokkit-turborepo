...
var pokkitDeployerCollectionsSchema []byte

func mergePokkitDeployerDbCollectionsFromSchema(app pbCore.App) error {
	err := app.ImportCollectionsByMarshaledJSON(pokkitDeployerCollectionsSchema, false)
	if err != nil {
		return fmt.Errorf("Error importing pokkitDeployerCollectionsSchema in mergePokkitDeployerDbCollectionsFromSchema: %w", err)
	}

	return nil
}

// func mergePokkitDeployerDbCollectionsProgrammatically(app pbCore.App) error {
// 	globalUserPermissionsCollection, err := app.FindCollectionByNameOrId(globalUserPermissionsCollectionName)
// 	if err != nil && !errors.Is(err, sql.ErrNoRows) {
// 		return fmt.Errorf("Error finding globalUserPermissions collection in mergePokkitDeployerDbCollectionsProgrammatically: %w", err)
// 	}
// 	organisationUserPermissionsCollection, err := app.FindCollectionByNameOrId(organisationUserPermissionsCollectionName)
// 	if err != nil && !errors.Is(err, sql.ErrNoRows) {
// 		return fmt.Errorf("Error finding organisationUserPermissions collection in mergePokkitDeployerDbCollectionsProgrammatically: %w", err)
// 	}
// 	organisationsCollection, err := app.FindCollectionByNameOrId(organisationsCollectionName)
// 	if err != nil && !errors.Is(err, sql.ErrNoRows) {
// 		return fmt.Errorf("Error finding organisations collection in mergePokkitDeployerDbCollectionsProgrammatically: %w", err)
// 	}
// 	usersCollection, err := app.FindCollectionByNameOrId(usersCollectionName)
// 	if err != nil {
// 		return fmt.Errorf("Error finding users collection in mergePokkitDeployerDbCollectionsProgrammatically: %w", err)
// 	}
...
// 		if err != nil {
// 			return fmt.Errorf("Error adding organisations collection in mergePokkitDeployerDbCollectionsProgrammatically: %w", err)
// 		}
// 	}
...
// 		if err != nil {
// 			return fmt.Errorf("Error adding globalUserPermissions collection in mergePokkitDeployerDbCollectionsProgrammatically: %w", err)
// 		}
// 	}
...
// 		if err != nil {
// 			return fmt.Errorf("Error adding organisationUserPermissions collection in mergePokkitDeployerDbCollectionsProgrammatically: %w", err)
// 		}
// 	}
