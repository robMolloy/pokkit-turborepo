...
const testMetadata = pokkitDbBlogTestsMetadata.pokkitDbBlogPostsCollectionCreate;
...
describe(`${testSuiteName} tests`, () => {
  ...
  it("PDB-BP-CREATE-01 — Global Superadmin (approved) can CREATE", async () => {
  ...
  it("PDB-BP-CREATE-02 — Global Superadmin (pending or blocked) cannot CREATE", async () => {
    const superadminPb = createPbConnection();
    const superadminUserPayload = userPayloadBuilder.forCreateRandomData();
    await superadminPb.collection(usersCollectionName).create(superadminUserPayload);
    await superadminPb
  ...
  it("PDB-BP-CREATE-03 — Global Admin (approved) can CREATE", async () => {
    const superadminPb = createPbConnection();
    const superadminUserPayload = userPayloadBuilder.forCreateRandomData();
    await superadminPb.collection(usersCollectionName).create(superadminUserPayload);
    await superadminPb
  ...
  it("PDB-BP-CREATE-04 — Global Admin (pending or blocked) cannot CREATE", async () => {
    const superadminPb = createPbConnection();
    const superadminUserPayload = userPayloadBuilder.forCreateRandomData();
    await superadminPb.collection(usersCollectionName).create(superadminUserPayload);
    await superadminPb
  ...
  it("PDB-BP-CREATE-05 — Global Standard (approved, pending or blocked) cannot CREATE", async () => {
    const superadminPb = createPbConnection();
    const superadminUserPayload = userPayloadBuilder.forCreateRandomData();
    await superadminPb.collection(usersCollectionName).create(superadminUserPayload);
    await superadminPb
