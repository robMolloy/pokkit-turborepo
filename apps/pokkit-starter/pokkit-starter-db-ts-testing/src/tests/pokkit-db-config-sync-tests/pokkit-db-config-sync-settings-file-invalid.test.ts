...
const testMetadata = pokkitDbConfigSyncTestsMetadata.settingsFileInvalid;
...
describe(`${testSuiteName} tests`, () => {
  beforeAll(async () => {
    ...
    fse.writeFileSync(getPokkitDbSettingsFilePath({ pbDirPath }), "some invalid JSON");
  ...
  it("PDBCS-SET-02 — Invalid settings file fails on startup", async () => {
